        ...
        <div class="page-breadcrumb">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="admin/food-item" class="breadcrumb-link">All Food Items</a></li>
        ...
        <div class="card-body">
          <form action="#" id="basicform" data-parsley-validate="">
            ...
            <div class="form-group">
              ...
              <input id="inputItem" type="text" name="item" data-parsley-trigger="change" required="" placeholder="Enter Item Price" autocomplete="off" class="form-control">
            </div>
            <div class="form-group">
              <label for="inputItemImageUrl">Item Image URL</label>
              <input id="inputItemImageUrl" type="text" name="item" data-parsley-trigger="change" required="" placeholder="http://www.billy.com/img/burgers.jpg" autocomplete="off" class="form-control">
